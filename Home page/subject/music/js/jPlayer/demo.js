$(document).ready(function () {
  var myPlaylist = new jPlayerPlaylist({
    ...
    { title: "2027年", artist: "まももP", mp3: "http://jqueryplugins.qiniudn.com/jq22m1.mp3", poster: "images/p1.jpg" },
    { title: "BRAVE THE OCEAN <MODv>", artist: "Eliana", mp3: "src/audio/Eliana - BRAVE THE OCEAN ＜MODv＞.mp3", poster: "images/p2.jpg" },
    { title: "Qaijff - セツナロマンチック", artist: "Qaijff", mp3: "src/audio/Qaijff - セツナロマンチック.mp3", poster: "images/p3.jpg" },
    { title: "Annabel - 夕暮れのグランド", artist: "Annabel", mp3: "src/audio/Annabel - 夕暮れのグランド.mp3", poster: "images/m0.jpg" },
    { title: "gravityWall (Instrumental)", artist: "Hiroyuki Sawano", mp3: "src/audio/SawanoHiroyuki[nZk] - gravityWall (Instrumental).mp3 ", poster: "images/m0.jpg" },
    { title: "Electro Freak", artist: "Studios", mp3: "http://music.163.com/song/media/outer/url?id=448153.mp3", poster: "images/m0.jpg" },
    { title: "Mother", artist: "Sound Horizon", mp3: "src/audio/Sound Horizon - Mother.mp3", poster: "images/m0.jpg" }
  ],
    {
      playlistOptions: {
