...
var minuteText = ["零分", "一   分", "二   分", "三   分", "四   分", "五   分", "六   分", "七   分", "八   分", "九   分", "十   分",
...
var secondsText = ["01秒", "02秒", "03秒", "04秒", "05秒", "06秒", "07秒", "08秒", "09秒", "10秒", "11秒", "12秒",
    "13秒", "14秒", "15秒", "16秒", "17秒", "18秒", "19秒", "20秒", "21秒", "22秒", "23秒", "24秒", "25秒", "26秒",
    "27秒", "28秒", "29秒", "30秒", "31秒", "32秒", "33秒", "34秒", "35秒", "36秒", "37秒", "38秒", "39秒", "40秒",
    "41秒", "42秒", "43秒", "44秒", "45秒", "46秒", "47秒", "48秒", "49秒", "50秒", "51秒", "52秒", "53秒", "54秒",
    "55秒", "56秒", "57秒", "58秒", "59秒", "60秒",];
...
function initTransition() {
    for (var i in textList) {
        for (var item of textList[i][1]) {
            ...
            item.style.transform = 'translate(' + i * 70 + 'px,-50%)'
            item.style.transformOrigin = -(i * 52) + 'px 50%';
...
function rotateTransition(timeArr) {
    for (var i in textList) {
        for (var j in textList[i][1]) {
            ...
            var temp = textList[i][1][j];
            var deg = 360 / textList[i][0].length * (j - timeArr[i]);
            temp.style.transform = 'translate(' + i * 52 + 'px,-50%)' + ' rotate(' + deg + 'deg)';
